...
<body class="min-h-screen text-white flex items-center justify-center p-4">
        ...
        <div class="highlight-box rounded-xl p-4 mb-4">
          <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <p class="font-mono text-sm">xivix.kr@gmail.com</p>
            </div>
          </div>
          ...
          <div class="space-y-3 text-sm">
            ...
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <span class="text-white/80">이메일: <strong class="gold">xivix.kr@gmail.com</strong></span>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    function copyInviteEmail() {
      const email = 'xivix.kr@gmail.com';
