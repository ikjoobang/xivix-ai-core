-- XIVIX AI Core V1.0 - Seed Data for Development

-- Insert default admin user
INSERT OR IGNORE INTO users (email, name, password_hash, role, api_key) VALUES 
...
INSERT OR IGNORE INTO conversation_logs (store_id, customer_id, message_type, customer_message, ai_response, response_time_ms, converted_to_reservation) VALUES 
  ...
  (1, 'customer_002', 'text', '가격표 좀 알려주세요', '뷰티플 스킨케어 가격 안내드립니다.\n\n• 기초 피부관리: 80,000원 (60분)\n• 프리미엄 케어: 150,000원 (90분)\n• 스페셜 트리트먼트: 200,000원 (120분)\n\n첫 방문 고객님께는 10% 할인 혜택도 있습니다. 예약 도와드릴까요?', 380, 0),
...
INSERT OR IGNORE INTO reservations (store_id, customer_id, customer_name, service_name, reservation_date, reservation_time, status, created_by) VALUES 
